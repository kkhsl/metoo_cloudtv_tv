...
public class RoomProgramManagerController {
    ...
    public Object program(@RequestBody RoomProgramDto dto) {
        ...
        if(totalRow > 0){
            int totalPages = totalRow / dto.getCurrentPage();
    ...
    @RequiresPermissions("ADMIN:PROGRAM:ADD")
...
/*        params.clear();
    ...
    @RequiresPermissions("ADMIN:PROGRAM:UPDATE")
    @ApiOperation("直播更新")
...
/*         User user = ShiroUserHolder.currentUser();
    ...
    @RequiresPermissions("ADMIN:PROGRAM:SAVE")
